...
export function Footer({
    ...
    description = "Professional seat map editor for theaters, stadiums, and event venues.",
    sections = [],
    showSocial = true,
    variant = "default",
    ...
    return (
        <footer
            className={clx(
                ...
                // Variants
                variant === "default" && "bg-gray-50 border-gray-200",
                variant === "minimal" && "bg-white border-gray-100",
                variant === "dark" && "bg-gray-900 border-gray-800 text-white",
                        ...
                        <div className="lg:col-span-1">
                            <div className="flex items-center gap-2 mb-4">
                                <div className={clx(
                                    ...
                                    variant === "dark" ? "bg-blue-600" : "bg-blue-600",
                                )}>
                                        ...
                                        <li key={linkIndex}>
                                            <button
                                                ...
                                                className={clx(
                                                    ...
                                                    variant === "dark" ? "text-gray-300 hover:text-white" : "text-gray-600 hover:text-gray-900",
                                                )}
                                            >
                                                {link.label}
                                            </button>
